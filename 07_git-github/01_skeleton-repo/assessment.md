...
Mini-project title:skeleton-repo

Submission date: 2025-27-01

Project GitHub subdirectory URL: https://github.com/AzizAlHothi/Donation-Project
...
I learned and applied the knowledge in the slides in how to manage a README.md file , and how it can dilute the 
complexity of a vast directory. I also learned how to use RStudio and GitHub together to create a seamless workflow in version control using informative commit message
that show each step of my changes. I also learned how to utilize the .gitignore file to exclude a supposed private and heavy data from being incldued the git repo. 
I also exercises some rudimentary essentials in data cleaning and analysis , though it was mock data. 
